...
var e = {
    ...
    hoverSdgs: function () {
        // hoverMeNow
        let hoverMeNow = document.querySelectorAll("#hoverMeNow");
        if (hoverMeNow) {
            hoverMeNow.forEach((element) => {
                element.addEventListener("mouseover", function () {
                    let showMeNow = element.querySelector("#showMeNow");
                    showMeNow.classList.remove("d-none");
                });

                element.addEventListener("mouseout", function () {
                    let showMeNow = element.querySelector("#showMeNow");
                    showMeNow.classList.add("d-none");
                });
            });
        }
    },
